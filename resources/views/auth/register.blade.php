...
<div class="row">
  <h2  style="color:#3544ab;text-transform: capitalize;margin-top: 2%;">{{Request::segment(1)}}  {{Request::segment(2)}} :</h2>
</div>
...
<div class="row">
<a style="color:#3544ab;margin: 1%;font-size: 20px;" href="/user/login">if you had join us please click to login</a>
</div>
