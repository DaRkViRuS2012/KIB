...
@endif
  ...
  <div class="col-6">
<form  class="container" action='/admin/about us/create' method="POST" enctype="multipart/form-data">
  @csrf
    ...
    <input name="address" class="form-control" rows="5" id="comment" required>
  ...
  <div id="us2" style="width: 500px; height: 400px;"></div>
    ...
    <input name="lat" class="form-control"  id="lat" required>
    
  </div>

       <div class="form-group">
    <label for="exampleInputEmail1">lang</label>
    <input name="lang" class="form-control"  id="lang" required>
